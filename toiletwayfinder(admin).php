...
<head>
	...
	<title> Toilet Locator (Admin)</title>
    
</head>  
<body>
	<h1><a href="toiletlocator.html"><img src="" alt="Toilet Wayfinder Admin" height= "150" width= "500"/></a></h1>
		<br>
		<hr>
		<br>
        <a href="home.html"><img id="home"  alt="homebtn" height= "40" width= "100"/></a>
		<button onclick="currentLocation()" style="height:60px">Current Location</button>
		<br>
		<p id="error"> </p>
		<br>
