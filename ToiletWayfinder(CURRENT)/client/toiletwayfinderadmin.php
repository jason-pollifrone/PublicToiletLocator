<?php
        ...
        if(!isset($_SESSION['login'])){
            header('Location: toiletwayfinderadmin.php');
        }
?>
...
<head>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD9fxFh1sqOfxvNB56Pqc3SWnXqBCAwQ_8&callback=googleMap"></script>
...
<body onload="currentLocation()">
	...
	<!--Logo-->
		<br>
		<a href="../client/toiletwayfinderadmin.php"><img src="../images/logo2.png" alt="banner" height= "100"/></a>
		<br>
		<hr>
		<a href="../server/logout.php" id="logout">Logout</a>
	<!--Current Location Button-->
		<br>
		<!--<input type="button" value="Detect Current Location" onclick="currentLocation()" />
		<p id="error"> </p>-->
...
<script>
  //define the current location pin icon
    var ic = 'https://titan.csit.rmit.edu.au/~s3430923/pp/locator.png';    
      
    //navigator and calls two functions
      function currentLocation(){
        navigator.geolocation.watchPosition(getPosition,error);

    }
//function to drop pin on current location and shows current location
 ...
 //marker details
       if (currentLoc && currentLoc.setMap) {
      ...
      //define locations for each marker
      var locations = [
...
//define info window for markers
    var infowindow = new google.maps.InfoWindow();
    
//define markers
    var i;
//loops for multiple markers
...
//click event listener for markers to show description and when click show direction
        ...
        return function() {
          ...
          longM = marker.getPosition().lng();
            ...
            directionsService.route(request, function(response, status) {
                ...
                var step = 1;  
                    infowindow2.setContent("Distance: " + response.routes[0].legs[0].distance.text + "<br>" + "Duration: " + response.routes[0].legs[0].duration.text + " ");
...
google.maps.event.addListener(map, 'click', function(event) {
   placeMarker(event.latLng);
     ...
     //zoom and panto current location
     map.setZoom(18);
     map.panTo(myLatLng);
    }
//error function
...
<footer>Return to <a href="../client/index.html">Index</a>
</footer>
</html>	